...
namespace WebPerformanceMeter.PerformancePlans
{
    ...
    /// 
    /// </summary>
    public abstract class UsersOnPeriodBase : UsersPerformancePlan
    {
        ...
        private void CalculateUserCountOnInterval(ref int userCount, ref int interval)
        {
            ...
            {
                userCount *= (int)this.minimalInvokePeriod.TotalMilliseconds / this._interval;
